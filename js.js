function rand(max) {
  ...
  function spawn(r,c)
  {
    ...
    for(i=0;i<10;i++)
    {
        for(r=0;r<10;r++)
        {
            ...
            {
                field.potata.push(field.field[i][r]);
            }
        }
    }
 ...
 class cell
 {
    constructor(y,x)
    {
        ...
        this.isFilled=false;
        this.isNear=false;
        field.html.innerHTML+=`<div onclick="tap(this)" class="node" y="${y}" x="${x}"><div oncontextmenu="flag(this)" class="bl"><img src="fl.png" alt=""></div><img src="po.png" alt=""></div>`;
